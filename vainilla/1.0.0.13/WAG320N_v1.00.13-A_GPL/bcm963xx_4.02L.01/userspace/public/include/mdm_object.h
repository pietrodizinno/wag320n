 ...
 *
 * MDMOID_Q_MGMT_CLASSIFICATION 30
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_LAN_IP_INTF_FIREWALL_EXCEPTION 37
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DHCP_CONDITIONAL_SERVING 39
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief Obj struct for InternetGatewayDevice.WANDevice.{i}.X_BROADCOM_COM_ATM_Interface_Stats.
 *
 * MDMOID_WAN_ATM_INTF_STATS 66
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
} WanAtmIntfStatsObject;

/*! \brief _WanAtmIntfStatsObject is used internally to represent WanAtmIntfStatsObject */
typedef WanAtmIntfStatsObject _WanAtmIntfStatsObject;



/*! \brief Obj struct for InternetGatewayDevice.WANDevice.{i}.X_BROADCOM_COM_ATM_Interface_Stats.ATM.
 *
 * MDMOID_WAN_ATM_STATS 67
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    ...
    UINT32    inErrors;	/**< InErrors */
    UINT32    inUnknown;	/**< InUnknown */
    UINT32    inHecErrors;	/**< InHecErrors */
    UINT32    inInvalidVpiVciErrors;	/**< InInvalidVpiVciErrors */
    UINT32    inPortNotEnableErrors;	/**< InPortNotEnableErrors */
    UINT32    inPtiError;	/**< InPtiError */
    UINT32    inIdleCells;	/**< InIdleCells */
    UINT32    inCircuitTypeErrors;	/**< InCircuitTypeErrors */
    UINT32    inOAMCrcErrors;	/**< InOAMCrcErrors */
    UINT32    inGfcError;	/**< InGfcError */
} WanAtmStatsObject;

/*! \brief _WanAtmStatsObject is used internally to represent WanAtmStatsObject */
typedef WanAtmStatsObject _WanAtmStatsObject;



/*! \brief Obj struct for InternetGatewayDevice.WANDevice.{i}.X_BROADCOM_COM_ATM_Interface_Stats.AAL5.
 *
 * MDMOID_WAN_AAL5_STATS 68
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UINT32    inOctets;	/**< InOctets */
    UINT32    outOctets;	/**< OutOctets */
    UINT32    inUcastPkts;	/**< InUcastPkts */
    UINT32    OUtUcastPkts;	/**< OUtUcastPkts */
    UINT32    inErrors;	/**< InErrors */
    UINT32    outErrors;	/**< OutErrors */
    UINT32    inDiscards;	/**< InDiscards */
    UINT32    outDiscards;	/**< OutDiscards */
} WanAal5StatsObject;

/*! \brief _WanAal5StatsObject is used internally to represent WanAal5StatsObject */
typedef WanAal5StatsObject _WanAal5StatsObject;



/*! \brief Obj struct for InternetGatewayDevice.WANDevice.{i}.X_BROADCOM_COM_ATM_Interface_Stats.AAL2.
 *
 * MDMOID_WAN_AAL2_STATS 69
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
/*! \brief _WanAal2StatsObject is used internally to represent WanAal2StatsObject */
typedef WanAal2StatsObject _WanAal2StatsObject;



/*! \brief Obj struct for InternetGatewayDevice.WANDevice.{i}.WANDSLInterfaceConfig.
 *
 * MDMOID_WAN_DSL_INTF_CFG 70
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    ...
    UBOOL8    X_BROADCOM_COM_ADSL2_AnnexA;	/**< X_BROADCOM_COM_ADSL2_AnnexA */
#endif
 ...
 *
 * MDMOID_WAN_DSL_INTF_STATS_TOTAL 73
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_PROPRIETARY_DIAG 76
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DSL_DIAG_NON_LINEARITY 78
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_END_TO_END_LOOPBACK_DIAG 80
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F4_LOOPBACK_DIAG 81
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_ATM_F5_END_TO_END_LOOPBACK_DIAG 82
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
...
typedef struct
{
    ...
    UINT32    X_BROADCOM_COM_VCC_SAR_Timeouts;	/**< X_BROADCOM_COM_VCC_SAR_Timeouts */
    UINT32    X_BROADCOM_COM_VCC_OversizedSDU;	/**< X_BROADCOM_COM_VCC_OversizedSDU */
    UINT32    X_BROADCOM_COM_VCC_ShortPacketErrors;	/**< X_BROADCOM_COM_VCC_ShortPacketErrors */
    UINT32    X_BROADCOM_COM_VCC_LengthError;	/**< X_BROADCOM_COM_VCC_LengthError */
    char *    X_BROADCOM_COM_ConnectionMode;	/**< X_BROADCOM_COM_ConnectionMode */
    char *    X_BROADCOM_COM_IfName;	/**< X_BROADCOM_COM_IfName */
} WanDslLinkCfgObject;
 ...
 *
 * MDMOID_WAN_ATM5_LOOPBACK_DIAG 85
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORTMAPPING 89
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_PORT_TRIGGERING 90
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_IP_CONN_FIREWALL_EXCEPTION 91
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORTMAPPING 96
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_PORT_TRIGGERING 97
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_PPP_CONN_FIREWALL_EXCEPTION 98
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_L3_FORWARDING_ENTRY 101
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING 102
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_I_PV6_L3_FORWARDING_ENTRY 103
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_ACCESS_TIME_RESTRICTION 126
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_WAN_DEBUG_PORT_MIRRORING_CFG 131
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UINT32    recNo;	/**< RecNo */
    char *    monitorPort;	/**< MonitorPort */
    char *    mirrorPort;	/**< MirrorPort */
    char *    direction;	/**< Direction */
 ...
 *
 * MDMOID_GPON_SOFTWARE_IMAGE 140
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_PPTP_VIDEO_ANI 147
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_PPTP_VIDEO_UNI 148
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_PPTP_ETHERNET_UNI 149
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_ETHERNET_PM_HISTORY_DATA 150
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_VLAN_TAGGING_OPERATION_CFG_DATA 151
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_MAC_BRIDGE_SERVICE_PROFILE 153
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_GAL_ETHERNET_PROFILE 154
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_GEM_PORT_NETWORK_CTP 155
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_GEM_PORT_PM_HISTORY_DATA 156
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_GEM_INTERWORKING_TP 158
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_GPON_GAL_ETHERNET_PM_HISTORY_DATA 159
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
