/*
 * $Id: mtd_blkdevs.c,v 1.1.1.1 2009-01-05 09:00:55 fred_fu Exp $
 *
...
#else
    /* Priority is lower than ksoftirqd, i.e. 99 - BRCM_SOFTIRQD_RTPRIO - 1 */
	struct sched_param param = { .sched_priority = BRCM_SOFTIRQD_RTPRIO - 1 };
#endif
