...
static ssize_t proc_write_log_fops(struct file *filp,const char *buffer,
...
static struct file_operations log_fops = {        
	write: proc_write_log_fops,        
};

static struct proc_dir_entry *log_file;
static int init_log_proc(void);

static int init_log_proc()
{	
/* create the /proc file */	
	log_file = create_proc_entry("log", 0644, NULL);
	if (log_file == NULL) 
	{	
