...
#if defined(CONFIG_SERCOMM_CODE)    
    // Falcon Shen add to remove interface parameter in order to make GUI saving not to reboot
	// when user remove vcc by 'killall pvc2684d', we should force to release netdev 
	DPRINTK("rt2684_unregister_netdev\n");
