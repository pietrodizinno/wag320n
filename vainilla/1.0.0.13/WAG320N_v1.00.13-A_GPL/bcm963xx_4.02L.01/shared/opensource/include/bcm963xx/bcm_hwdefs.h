...
#if defined (CONFIG_16M_FLASH)
#define PHYS_FLASH_BASE         0x1E000000
#elif defined(CONFIG_8M_FLASH)
#define PHYS_FLASH_BASE         0x1F800000
#else    
...
#if defined(_BCM96338_) || defined(CONFIG_BCM96338) || defined(CONFIG_BRCM_IKOS) || defined(CONFIG_BCM96358)
#if defined (CONFIG_16M_FLASH)
...
#elif defined(CONFIG_8M_FLASH)
#define THREAD_NUM_ADDRESS              (0x80000000 + THREAD_NUM_ADDRESS_OFFSET + 0x00400000)
#else    
#define THREAD_NUM_ADDRESS              (0x80000000 + THREAD_NUM_ADDRESS_OFFSET)
#endif
