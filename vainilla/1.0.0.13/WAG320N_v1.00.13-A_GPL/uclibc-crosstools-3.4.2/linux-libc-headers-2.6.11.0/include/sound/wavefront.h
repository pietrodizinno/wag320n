...
struct wf_envelope
{
    ...
    __u8 attack_velocity:7;
    __u8 Unused7:1;

    __u8 volume_velocity:7;
    __u8 Unused8:1;

    __u8 keyboard_scaling:7;
    __u8 Unused9:1;
};
...
struct wf_lfo
{
    ...
    __u8 ramp_delay:7;
    __u8 wave_restart:1; /* for LFO2 only */
...
struct wf_patch
{
    __s16  frequency_bias;         /*  ** THIS IS IN MOTOROLA FORMAT!! ** */

    __u8 amplitude_bias:7;
    __u8 Unused1:1;
    ...
    __u8 nohold:1;
    __u8 restart:1;
    __u8 filterconfig:2; /* SDK says "not used" */
    __u8 reuse:1;
    __u8 reset_lfo:1;    
    ...
    __s8 fc1_mod_amount;
    __s8 fc1_keyboard_scaling;
    __s8 fc1_bias;
    __s8 fc2_mod_amount;
    __s8 fc2_keyboard_scaling;
    __s8 fc2_bias;
...
typedef struct wf_sample {
    ...
    __s16 FrequencyBias;
    __u8 SampleResolution:2;  /* sample_format */
    __u8 Unused1:1;
    __u8 Loop:1;
    __u8 Bidirectional:1;
    __u8 Unused2:1;
    __u8 Reverse:1;
    __u8 Unused3:1;
} wavefront_sample;
...
typedef struct wf_multisample {
    __s16 NumberOfSamples;   /* log2 of the number of samples */
    __s16 SampleNumber[NUM_MIDIKEYS];
} wavefront_multisample;

typedef struct wf_alias {
    __s16 OriginalSample __attribute__ ((packed));
    ...
    __s16  FrequencyBias __attribute__ ((packed));

    __u8 SampleResolution:2  __attribute__ ((packed));
    __u8 Unused1:1  __attribute__ ((packed));
    __u8 Loop:1 __attribute__ ((packed));
    __u8 Bidirectional:1  __attribute__ ((packed));
    __u8 Unused2:1 __attribute__ ((packed));
    __u8 Reverse:1 __attribute__ ((packed));
    __u8 Unused3:1 __attribute__ ((packed)); 
    ...
    */
    ...
    __u8 sixteen_bit_padding __attribute__ ((packed));
} wavefront_alias;
...
typedef struct wf_patch_info {
    ...
    */
    ...
    __s16   key;               /* Use WAVEFRONT_PATCH here */
    __u16  devno;             /* fill in when sending */
    __u8  subkey;            /* WF_ST_{SAMPLE,ALIAS,etc.} */

#define WAVEFRONT_FIND_FREE_SAMPLE_SLOT 999

    __u16  number;            /* patch/sample/prog number */

    __u32  size;              /* size of any data included in 
    ...
    __u16 *dataptr;            /* actual sample data */
