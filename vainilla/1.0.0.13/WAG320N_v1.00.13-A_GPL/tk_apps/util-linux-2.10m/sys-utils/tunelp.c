...
/* $Id: tunelp.c,v 1.1.1.1 2009-07-10 06:31:33 shearer_lu Exp $
 * $Log: tunelp.c,v $
 * Revision 1.1.1.1  2009-07-10 06:31:33  shearer_lu
 * BugFix:
 * Auth/Model: Shearer Lu/WAG320N
 * Porting:
 * Description:
 * Add it for GPL release.
 *
 *
