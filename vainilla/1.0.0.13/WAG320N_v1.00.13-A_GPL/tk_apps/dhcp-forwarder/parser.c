// $Id: parser.c,v 1.2 2009-04-30 03:25:35 kylin_kang Exp $    --*- c++ -*--
    ...
    /*@modifies CHARACTERS, *chrs@*/
{
  ...
  chrs['\t'] |= chrBLANK;
  chrs[' ']  |= chrBLANK;
  chrs['.']  |= chrIP | chrSYS | chrUSERNAME; // kylin: boone shen,modify for ethwan ifname eth0.x,chrFILENAME -> chrSYS,090107.
