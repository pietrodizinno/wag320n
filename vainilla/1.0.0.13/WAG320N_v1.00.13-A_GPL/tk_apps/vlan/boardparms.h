...
#define BP_ENET_EXTERNAL_SWITCH_REVERSE_MII          2
#define BP_ENET_EXTERNAL_SWITCH_NO_REVERSE_MII       3
#define BP_ENET_EXTERNAL_SWITCH_REVERSE_MII_SPIDEV_1 4
#define BP_ENET_EXTERNAL_SWITCH_REVERSE_MII_MDIO     5
#define BP_ENET_EXTERNAL_PHY                         6
...
typedef struct EthernetMacInfo
{
    ...
    unsigned short numSwitchPorts;              /* Number of external switch ports */
