 ...
 *
 * $Id: vector.c,v 1.1.1.1 2009-02-18 08:33:39 andy_huang Exp $
 */
...
//add by john
int vector_search_peerid(VECTOR *v, int key, PPTP_CALL **call)
{
	struct vector_item *tmp=NULL;
	PPTP_CALL *icall;
	int i;
