...
{
	printf(
"STRING_GET match v%s options:\n"
"--stringGET [!] string         Match a string in the line which include \"GET\" in packets\n",
IPTABLES_VERSION);
...
final_check(unsigned int flags)
{
	if (!flags)
		exit_error(PARAMETER_PROBLEM,
			   "STRING_GET match: You must specify `--string'");
}
...
static
struct iptables_match stringGET
= {
    .name			= "stringGET",
