...
//#define HAVE_DECODE_KRB5_AP_REQ 1
...
//#define HAVE_KRB5_FREE_AP_REQ 1
...
/* Static init functions */
//#define static_init_pdb { pdb_ldap_init(); pdb_smbpasswd_init(); pdb_tdbsam_init(); pdb_guest_init();}
#define static_init_pdb { pdb_smbpasswd_init(); pdb_tdbsam_init(); pdb_guest_init();}

/* Static init functions */
#define static_init_rpc { rpc_lsa_init(); rpc_reg_init(); rpc_lsa_ds_init(); rpc_wks_init(); rpc_svcctl_init(); rpc_net_init(); rpc_dfs_init(); rpc_srv_init(); rpc_spoolss_init(); rpc_eventlog_init(); rpc_samr_init();}
