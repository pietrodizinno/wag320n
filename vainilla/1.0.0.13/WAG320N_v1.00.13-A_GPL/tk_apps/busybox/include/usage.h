...
#define ping2file_trivial_usage "host"
#define ping2file_full_usage    "Send ICMP ECHO_REQUEST packets to network hosts"
#else
...
#define ping_full_usage \
	...
	"\t\t\tand when finished."
#define ping2file_trivial_usage \
        "[OPTION]... host"
#define ping2file_full_usage \
        "Send ICMP ECHO_REQUEST packets to network hosts.\n\n" \
        "Options:\n" \
        "\t-c COUNT\tSend only COUNT pings.\n" \
        "\t-s SIZE\t\tSend SIZE data bytes in packets (default=56).\n" \
